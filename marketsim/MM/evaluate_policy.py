...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--device", type=str, default="cuda" if torch.cuda.is_available() else "cpu",
                        help="Device to use")
    parser.add_argument("--resume_path", type=str, default="./root_result_RL/RLMM_RL_macrun1/policy.pth", help="Path to resume training")
...
def main():
    ...
    checkpoint_dir = checkpoint_dir + "_RLeval" + "_se_" + str(
